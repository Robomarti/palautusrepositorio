...
class TestKauppa(unittest.TestCase):
    ...
    def test_pankin_metodia_kutsutaan_oikealla_asiakkaalla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_pankin_metodia_kutsutaan_oikeailla_argumenteilla(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_yksi_tuote_loppu(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_aloita_asioiminen_nollaa(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_uusi_viite(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        pankki_mock.tilisiirto.assert_called_with("pekka", 2, "12345", "33333-44455", 8)
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        pankki_mock.tilisiirto.assert_called_with("pekka", 3, "12345", "33333-44455", 8)
